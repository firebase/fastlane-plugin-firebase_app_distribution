class FirebaseAppDistributionError < StandardError
    ...
    APK_NOT_FOUND = "Could not find the APK/IPA. Make sure you build first by running ./gradlew assemble[Variant], or set the apkPath parameter to point to your APK/IPA")
