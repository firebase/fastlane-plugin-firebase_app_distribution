      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :test_devices_file,
                                       ...
                                       description: "Comma-separated list of devices to run automated tests on, in the format '<model id>|<os version id>|<locale>|<orientation>' (e.g. 'shiba|34|en|portrait'). Run 'gcloud firebase test andoid|ios models list' to see available devices",
                                       optional: true,
                                       type: String),
          FastlaneCore::ConfigItem.new(key: :test_username,
                                       description: "The username for automatic login",
                                       optional: true,
                                       type: String),
          FastlaneCore::ConfigItem.new(key: :test_password,
                                       description: "The password for automatic login",
                                       optional: true,
                                       type: String),
          FastlaneCore::ConfigItem.new(key: :test_username_resource,
                                       description: "The resource name of the username field for automatic login",
                                       optional: true,
                                       type: String),
          FastlaneCore::ConfigItem.new(key: :test_password_resource,
                                       description: "The resource name of the password field for automatic login",
                                       optional: true,
                                       type: String),
